...
export default async function MateriaisPage() {
  ...
  return <><PageHeader title="Materiais" subtitle="Consulte os materiais compartilhados com suas turmas." />{error ? <div role="alert" className="rounded-md border border-danger-border bg-danger-dim p-4 text-sm text-danger-text">Não foi possível carregar os materiais. Tente novamente.</div> : <StudentMaterialsClient materials={list} />}</>;
}
