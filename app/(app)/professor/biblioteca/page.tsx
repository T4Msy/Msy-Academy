...
export default async function BibliotecaPage({
  ...
  return (
    <>
        ...
        <div>
          ...
          <p className="mt-1 text-[13.5px] text-muted-foreground">
            {list.length > 0
              ...
              : "Arquivos e outros materiais de estudo ficam aqui, pesquisáveis."}
          </p>
        </div>
      ...
      {list.length === 0 ? (
        <EmptyState variant="biblioteca" title="Nenhum material de estudo foi disponibilizado ainda" text="Adicione arquivos, links e outros recursos para apoiar os estudos dos alunos." />
      ) : (
