...
export function ExamForm() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      const res = await fetch("/api/exams/generate", { method: "POST", body });
          ...
          <div className="card-body">
            <fieldset className="field-group">
              ...
              <p className="field-hint">
                A seleção define o motor de geração utilizado para criar a prova.
              </p>
            </fieldset>
        ...
        <section className="card" id="step-4">
          ...
          <div className="card-body">
            <div className="toggle-row">
              <div className="toggle-info">
                ...
                <span className="toggle-desc">
                  Se ativado, envie um PDF para embasar as questões geradas.
                </span>
              </div>
              <button
                type="button"
            ...
            <div className="form-field" style={{ marginTop: 16 }}>
              ...
              >
                ...
                <div className="dz-text">
                  ...
                  <span className="dz-hint">
                    {apostila
                      ? "PDF selecionado. A IA pode usar esse conteúdo."
              ...
              />
              <p className="field-hint">
                Quando <b>Usar apostila</b> estiver ativado e um PDF selecionado, ele
                será usado como base para as questões.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="card-body">
            ...
            <div className="submit-row">
              <div className="submit-chips">
                <span className="chip">Auto Generate</span>
