    ...
    <>
      <div className="mb-6 flex flex-wrap items-end justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-[13.5px] text-muted-foreground">Gerencie suas preferências e informações da conta.</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-[repeat(auto-fit,minmax(320px,480px))] items-start gap-4">
        <AccountInformationCard email={user?.email ?? ""} isProfessor={roles.includes("PROFESSOR")} />
